...
- [Введение в мобильное тестирование](#введение-в-мобильное-тестирование)
- [Проблемы мобильного тестирования](#проблемы-мобильного-тестирования)
- [Инструменты мобильного тестирования](#инструменты-мобильного-тестирования)
- [Что такое Appium?](#что-такое-appium)
    - [Архитектура Appium](#архитектура-appium)
- [Установка и настройка Appium](#установка-и-настройка-appium)
    - [Шаги установки JDK + Android Studio](#шаги-установки-jdk--android-studio)
    - [Пример переменных окружения](#пример-переменных-окружения)
    - [Шаги установки xCode](#шаги-установки-xcode)
    - [Установка Appium](#установка-appium)
- [Разработка мобильных тестов на Appium](#разработка-мобильных-тестов-на-appium)
    - [SessionId](#sessionid)
    - [Инициализация Appium драйвера](#инициализация-appium-драйвера)
    - [Запуск и остановка сессии (Android)](#запуск-и-остановка-сессии-android)
    - [Запуск и остановка сессии (iOS)](#запуск-и-остановка-сессии-ios)
    - [Appium локаторы](#appium-локаторы)
    - [Appium ожидания](#appium-ожидания)
    - [Appium действия](#appium-действия)
    - [Appium как посмотреть код?](#appium-как-посмотреть-код)
    - [Как запустить браузерные тесты](#как-запустить-браузерные-тесты)
